...
- `package.json` — Node.js package manifest (~454 tok)
- `pnpm-lock.yaml` — pnpm lock file (~25323 tok)
...
- `vitest.config.ts` — Vitest test configuration (~71 tok)
...
- `01-01-PLAN.md` — Plan 01: Project Scaffold, Data Layer & Foundation Components (~7330 tok)
- `01-01-SUMMARY.md` — Phase 1 Plan 01: Project Scaffold, Data Layer & Foundation Components Summary (~2121 tok)
- `01-02-PLAN.md` — Plan 02: Task Management UI -- Input, List, Item, Categories, Subtasks (~5021 tok)
- `01-02-SUMMARY.md` — Phase 1 Plan 02: Task Management UI Summary (~1773 tok)
- `01-03-PLAN.md` — Plan 03: Drag Reorder, Export/Import & Settings Drawer (~4936 tok)
- `01-03-SUMMARY.md` — Dependency graph (~1583 tok)
- `01-HUMAN-UAT.md` — Current Test (~192 tok)
- `01-RESEARCH.md` — Phase 1: Foundation -- Tasks & Data Layer - Research (~10103 tok)
- `01-UI-SPEC.md` — Phase 1 — UI Design Contract (~3990 tok)
- `01-VALIDATION.md` — Phase 1 — Validation Strategy (~1307 tok)
- `01-VERIFICATION.md` — Phase 1: Foundation -- Tasks & Data Layer Verification Report (~5749 tok)

## .planning/phases/02-gamification-core-points-streaks/

- `02-01-PLAN.md` — Exports TaskType (~3907 tok)
- `02-01-SUMMARY.md` — Phase 2 Plan 01: Gamification Data Layer Summary (~1416 tok)
- `02-02-PLAN.md` — Exports PointTransactionType (~4628 tok)
- `02-02-SUMMARY.md` — Phase 2 Plan 02: Point & Streak Integration Summary (~1548 tok)
- `02-03-PLAN.md` — Exports usePointBalance (~6171 tok)
- `02-03-SUMMARY.md` — Dependency graph (~1815 tok)
- `02-CONTEXT.md` — Phase 2: Gamification Core - Context (~1240 tok)
- `02-DISCUSSION-LOG.md` — Phase 2: Gamification Core - Discussion Log (~302 tok)
- `02-RESEARCH.md` — Phase 2: Gamification Core - Points & Streaks - Research (~9191 tok)
- `02-VALIDATION.md` — Phase 2 — Validation Strategy (~954 tok)
- `02-VERIFICATION.md` — Phase 2: Gamification Core -- Points & Streaks Verification Report (~3681 tok)

## .planning/phases/03-mood-rewards/

- `03-01-PLAN.md` — Exports PointTransactionType (~3724 tok)
- `03-01-SUMMARY.md` — Dependency graph (~1351 tok)
- `03-02-PLAN.md` — Exports MoodEmoji (~5069 tok)
- `03-02-SUMMARY.md` — Dependency graph (~1253 tok)
- `03-03-PLAN.md` — Exports useMoodEntries (~12284 tok)
- `03-03-SUMMARY.md` — Dependency graph (~1516 tok)
- `03-CONTEXT.md` — Phase 3: Mood & Rewards - Context (~1601 tok)
- `03-DISCUSSION-LOG.md` — Phase 3: Mood & Rewards - Discussion Log (~394 tok)

## .planning/phases/04-mascot-animations/

- `04-01-PLAN.md` — Exports useUIStore (~3879 tok)
- `04-01-SUMMARY.md` — Dependency graph (~1294 tok)
- `04-02-PLAN.md` — Trust Boundaries (~3300 tok)
- `04-02-SUMMARY.md` — Dependency graph (~1034 tok)
- `04-03-PLAN.md` — Declares already (~4551 tok)
- `04-03-SUMMARY.md` — Dependency graph (~1380 tok)
- `04-CONTEXT.md` — Phase 4: Mascot & Animations - Context (~1820 tok)
- `04-DISCUSSION-LOG.md` — Phase 4: Mascot & Animations - Discussion Log (~1300 tok)
- `04-VERIFICATION.md` — Phase 4: Mascot & Animations Verification Report (~5599 tok)

## .planning/phases/05-summaries/

- `05-01-PLAN.md` — Exports MoodEmoji (~4285 tok)
- `05-01-SUMMARY.md` — Dependency graph (~1372 tok)
- `05-02-PLAN.md` — Exports DailySummary (~3695 tok)
- `05-02-SUMMARY.md` — Dependency graph (~1348 tok)
- `05-03-PLAN.md` — Exports useDailySummary (~5202 tok)
- `05-03-SUMMARY.md` — Dependency graph (~2031 tok)
- `05-CONTEXT.md` — Phase 5: Summaries & Insights - Context (~1930 tok)
- `05-DISCUSSION-LOG.md` — Phase 5: Summaries & Insights - Discussion Log (~743 tok)

## .planning/phases/06-mount-gamification-ui/

- `06-01-PLAN.md` — Plan 06-01: Mount Gamification UI in Topbar (~1558 tok)
- `06-01-SUMMARY.md` — Plan 06-01: Mount Gamification UI in Topbar (~353 tok)

## .planning/phases/08-codebase-cleanup/

- `08-01-PLAN.md` — Declares celebrate (~2232 tok)
- `08-01-SUMMARY.md` — Objective (~354 tok)
...
- `cat-celebrate.json` (~590 tok)
- `cat-encourage.json` (~718 tok)
...
- `Button.tsx` — variantClasses (~371 tok)
- `ConfirmDialog.tsx` — ConfirmDialog (~369 tok)
- `DifficultyBadge.tsx` — difficultyConfig (~272 tok)
- `EmptyState.tsx` — EmptyState (~99 tok)
- `Input.tsx` — Input (~342 tok)
- `Textarea.tsx` — Textarea (~369 tok)
- `Toast.tsx` — Toast (~236 tok)
...
- `PointBadge.test.tsx` — Mock framer-motion to avoid animation issues in tests (~520 tok)
- `TransactionPopover.test.tsx` — Mock date-fns (~1015 tok)
...
- `ANIMATIONS.md` — Mascot Animations — Asset Status (~382 tok)
- `mascot.css` — Styles: 5 rules, 1 media queries (~302 tok)
- `Mascot.tsx` — SPEECH_MESSAGES — uses useEffect, useCallback (~816 tok)
...
- `DailySummary.tsx` — DailySummary — uses useState, useEffect (~1882 tok)
- `MoodTrendChart.tsx` — rangeOptions — renders chart — uses useMemo (~1094 tok)
- `SummaryPage.tsx` — tabs — renders chart (~450 tok)
- `WeeklySummary.tsx` — DAY_LABELS — uses useState, useEffect (~3136 tok)

## src/components/tasks/

- `CategoryFilter.tsx` — CategoryFilter (~419 tok)
- `SubtaskList.tsx` — SubtaskList (~910 tok)
- `TaskInput.tsx` — TaskInput — uses useState, useCallback (~1800 tok)
- `TaskItem.tsx` — TaskItem — uses useState, useEffect, useCallback (~2651 tok)
- `TaskItemSortable.tsx` — TaskItemSortable (~417 tok)
- `TaskList.tsx` — TaskList — uses useState (~1388 tok)

## src/components/tasks/__tests__/

- `TaskItem.test.tsx` — createMockTask (~742 tok)
...
- `useExportImport.ts` — Exports exportData, importData (~239 tok)
...
- `id.ts` — Exports generateId (~27 tok)
